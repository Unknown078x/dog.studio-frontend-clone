  ...
  <img id="sevenBg" src={`${BASE}models/seventh.png`} alt="" />
        ...
        <section id='section1'>
          ...
          <nav>
            ...
            <div className="elem sh"><i class="ri-arrow-drop-right-line"></i>Our Showreel</div>
            <div className="elem"><i class="ri-menu-3-line"></i></div>
          </nav>
          ...
          <div className="bottom">
            ...
            <div className="right">
              ...
              <p className='pa'>Our goal is to deliver amazing experiences that make <br />
                people talk, and build strategic value for brands, tech, <br />
                entertainment, arts & culture.</p>

              <div className="tags">
                <a href="">Facebook<span> / </span> </a><a href="">Instagram <span> / </span></a><a href="">Dribbble <span> / </span></a><a href="">Twitter <span> / </span></a><a href="">Newsletter</a>
              </div>
            </div>
          </div>
        ...
        <section id='section2'>
          ...
          <div className="wrapper">
            <div img-title='oneBg' className="head">
              <div className="time">2020 - ONGOING</div>
              <div className="line">Tomorrowland</div>
            </div>
            <div img-title='twoBg' className="head">
              <div className="time">2018 - TODAY</div>
              <div className="line">Navy Pier</div>
            </div>
            <div img-title='threeBg' className="head">
              <div className="time">2015 - TODAY</div>
              <div className="line">MSI Chicago</div>
            </div>
            <div img-title='fourBg' className="head">
              <div className="time">2016</div>
              <div className="line">This Was Louise's Phone</div>
            </div>
            <div img-title='fiveBg' className="head">
              <div className="time">2012 - TODAY</div>
              <div className="line">KIKK Festival 2018</div>
            </div>
            <div img-title='sixBg' className="head">
              <div className="time">2017</div>
              <div className="line">The Kennedy Center</div>
            </div>
            <div img-title='sevenBg' className="head">
              <div className="time">2016 - ONGOING</div>
              <div className="line">Royal Opera Of Wallonia</div>
            </div>
        ...
        <section id='section4'>
          ...
          <div className="bottom">
            ...
            <div className="container">
              <div className="up">
                <div className="l">
                  <h3>Chicago<span>.</span></h3>
                  <h3>Amsterdam<span>.</span></h3>
                  <h3>Paris<span>.</span></h3>
                </div>
